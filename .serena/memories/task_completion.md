...
- Normal code/configuration change: `pnpm verify:fast`.
- Exports, dependencies, entry points, build output, reachability, or pre-integration evidence: `pnpm verify:full`.
...
- Stop when the requested behavior and relevant invariants are proven and no known task-related regression remains.
