...
export const globalSurfaces: readonly SurfaceDefinition[] = [
  ...
  {
    id: 'installations',
    href: '/settings/installations',
    placement: 'settings',
    audience: 'authenticated',
    availability: 'deferred',
    label: 'Installed Apps',
    description: 'Observed installation-management surface; machine authority remains deferred.'
  },
  {
    id: 'applications',
    ...
    availability: 'deferred',
    label: 'Applications',
    description: 'Observed authorized-application surface; OAuth authority remains deferred.'
  },
  {
    id: 'tokens',
    ...
    description: 'Observed programmatic-access surface; token issuance remains deferred.'
  }
] as const;
...
export function repositorySurfaces(route: RepositoryRouteAddress): readonly SurfaceDefinition[] {
  ...
  return [
    ...
    {
      id: 'wiki',
      href: repositoryWikiPath(route),
      placement: 'primary',
      audience: 'repository-reader',
      availability: 'live',
      label: 'Wiki',
      description: 'Repository knowledge projected from Page resources.'
    },
    {
      id: 'activity',
