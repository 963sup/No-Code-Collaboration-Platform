...
const context = [
  ...
  'Skill routing: explicit user-named skills win; otherwise choose the narrowest owner. github-semantics-first-principles owns GitHub-derived Product decisions and repository-wide semantic repair; first-principles owns broader or non-GitHub decisions. Skills route work and current repository contracts remain authoritative. plugin-development-workflow routes external tools/evidence only. Compose skills only for distinct responsibilities; never invoke overlaps for consensus.',
  'The github_semantics_first_principles agent may perform bounded repository-local implementation for its canonical Skill, but workspace write authority does not authorize Git publication, deployment, remote-provider mutation, or mirror writes.',
